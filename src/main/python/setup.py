'''
This script builds archives (zip files) for distributing and installing 
kurator-validation python resources (services, actors, and example scripts).

***** Building a source distribution ****

To build a source distribution archive run this script with the sdist argument
and find the archive (e.g. kurator-validation-0.1.tar.gz) in the dist subdirectory:
...
(e.g. kurator_curation-0.1-py2.py3-none-any.whl) in the dist directory. The wheel produced
...
$ pip install kurator_validation-0.3.1-py2.py3-none-any.whl
...
setup(
    name='kurator-validation',
    version='0.3.1',
    description='Data validation services and actors',
    author='Kurator Project',
    author_email='kurator@lists.illinois.edu',
    url='https://opensource.ncsa.illinois.edu/confluence/display/KURATOR/Kurator+Project+Home',
