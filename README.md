...
2.  Follow the instructions for [Developing new python actors](https://github.com/kurator-org/kurator-akka#developing-new-python-actors).  Make sure that the `JYTHON_HOME` environment variable refers to a directory containing a local Jython installation, e.g.:

        export KURATOR_LOCAL_PYTHON_LIB=$HOME/jython2.7.0
