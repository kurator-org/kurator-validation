...
__version__ = "utf8_encoder_test.py 2016-08-04T12:43+02:00"
...
class UTF8EncoderFramework():
    ...
    testfile1 = testdatapath + 'test_eight_specimen_records_utf8_lf.csv'
    testfile2 = testdatapath + 'test_thirty_records_mac_roman_crlf.csv'
